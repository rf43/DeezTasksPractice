...
private fun HomeScreenContent(
    ...
    Column(
        ...
        screenState.taskItems.forEachIndexed { index, taskItem ->
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Row(
                    ...
                    Column(
                        ...
                        Text(
                            ...
                            maxLines = 2,
                            overflow = TextOverflow.Ellipsis,
                            text = "${taskItem.description}: $index"
                        )
                    }
                    ...
                    Row(
                        ...
                        IconButton(
                            onClick = { onDeleteAction(taskItem) }
                        ) {
                            Icon(
                        ...
                        IconButton(
                            onClick = { onCompleteAction(taskItem) }
                        ) {
                            Icon(
                                painter = painterResource(
                                    id = if (taskItem.isCompleted) {
